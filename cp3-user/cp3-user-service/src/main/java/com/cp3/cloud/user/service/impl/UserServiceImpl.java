package com.cp3.cloud.user.service.impl;

import com.cp3.cloud.user.mapper.UserMapper;
import com.cp3.cloud.user.pojo.User;
import com.cp3.cloud.user.service.UserService;
import com.cp3.cloud.utils.CodecUtils;
import com.cp3.cloud.utils.JsonUtils;
import com.cp3.cloud.utils.NumberUtils;
...
public class UserServiceImpl implements UserService {
    ...
    private static final String KEY_PREFIX2 = "cp3:user:info";
    ...
    public Boolean sendVerifyCode(String phone) {
        ...
        try {
            ...
            msg.put("code",code);
            //2.发送短信
            this.amqpTemplate.convertAndSend("cp3.sms.exchange","sms.verify.code",msg);
