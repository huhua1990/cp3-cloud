package com.cp3.cloud.activiti.config.datasource;
...
@Slf4j
@MapperScan(
        basePackages = { BUSINESS_PACKAGE, UTIL_PACKAGE }, annotationClass = Repository.class,
        sqlSessionFactoryRef = ActivitiDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
...
public class ActivitiDatabaseAutoConfiguration extends BaseMasterDatabaseConfiguration {
    ...
    public ActivitiDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 cp3.database.multiTenantType!=DATASOURCE，加载了 ActivitiDatabaseAutoConfiguration");
    }
