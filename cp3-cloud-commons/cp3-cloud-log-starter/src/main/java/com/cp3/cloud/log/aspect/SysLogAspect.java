package com.cp3.cloud.log.aspect;
...
import com.cp3.cloud.context.ThreadLocalParam;
import com.cp3.cloud.jackson.JsonUtil;
import com.cp3.cloud.log.annotation.SysLog;
import com.cp3.cloud.log.entity.OptLogDTO;
import com.cp3.cloud.log.event.SysLogEvent;
import com.cp3.cloud.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.cp3.cloud.base.controller.*.*(..)) || @annotation(com.cp3.cloud.log.annotation.SysLog)")
