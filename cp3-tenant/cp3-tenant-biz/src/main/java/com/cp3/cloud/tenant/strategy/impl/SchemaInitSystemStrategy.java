...
import static com.cp3.cloud.common.constant.BizConstant.BASE_DATABASE;
import static com.cp3.cloud.common.constant.BizConstant.EXTEND_DATABASE;

/**
 * 初始化系统
 * <p>
 * 初始化规则：
 * cp3-authority-server/src/main/resources/sql 路径存放8个sql文件 (每个库对应一个文件)
