package com.cp3.cloud.seckill.service.impl;

import com.cp3.cloud.item.pojo.SeckillGoods;
import com.cp3.cloud.item.pojo.Stock;
import com.cp3.cloud.order.pojo.Order;
import com.cp3.cloud.order.pojo.OrderDetail;
import com.cp3.cloud.order.pojo.SeckillOrder;
import com.cp3.cloud.seckill.client.GoodsClient;
import com.cp3.cloud.seckill.client.OrderClient;
import com.cp3.cloud.seckill.mapper.SeckillMapper;
import com.cp3.cloud.seckill.mapper.SeckillOrderMapper;
import com.cp3.cloud.seckill.mapper.SkuMapper;
import com.cp3.cloud.seckill.mapper.StockMapper;
import com.cp3.cloud.seckill.service.SeckillService;
import com.cp3.cloud.seckill.vo.SeckillMessage;
import com.cp3.cloud.utils.JsonUtils;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    private static final String KEY_PREFIX_PATH = "cp3:seckill:path";
