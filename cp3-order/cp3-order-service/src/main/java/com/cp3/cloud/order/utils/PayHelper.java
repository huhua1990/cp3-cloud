package com.cp3.cloud.order.utils;

import com.github.wxpay.sdk.WXPay;
import com.cp3.cloud.order.config.PayConfig;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        String key = "cp3.pay.url." + orderId;
        try {
        ...
        try {
            ...
            //回调地址
            data.put("notify_url", "http://test.cp3.com/wxpay/notify");
            // 交易类型为扫码支付
