package com.cp3.cloud.upload.service.impl;

import com.github.tobato.fastdfs.domain.StorePath;
import com.github.tobato.fastdfs.service.FastFileStorageClient;
import com.cp3.cloud.upload.service.UploadService;
...
//            file.transferTo(new File(dir, Objects.requireNonNull(file.getOriginalFilename())));
            ...
            //String url = "http://image.cp3.com/upload/"+file.getOriginalFilename();
            //String url = "http://image.cp3.com/"+storePath.getFullPath();
            String url = "http://10.45.50.241:9999/"+storePath.getFullPath();
