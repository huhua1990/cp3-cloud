...
import com.cp3.base.cloud.feign.DateFormatRegister;
import com.cp3.base.cloud.hystrix.ThreadLocalHystrixConcurrencyStrategy;
import com.cp3.base.cloud.interceptor.FeignAddHeaderRequestInterceptor;
import feign.Feign;
