...
public class UriSecurityPreAuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * com.cp3.base.basic.controller.*.*(..)) || " +
            "@annotation(com.cp3.base.annotation.security.PreAuth) || " +
            "@within(com.cp3.base.annotation.security.PreAuth)"
    )
