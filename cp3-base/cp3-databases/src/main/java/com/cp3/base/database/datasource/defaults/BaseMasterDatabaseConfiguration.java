package com.cp3.base.database.datasource.defaults;
...
import com.cp3.base.database.datasource.BaseDatabaseConfiguration;
 ...
 * <p>
 * 1. 本类的子类的 @MapperScan(basePackages = {"com.cp3.base"}) 修改为  @MapperScan(basePackages = {"com.cp3.base.product.dao"})
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.cp3.base"}, 修改为  basePackages = {"com.cp3.base.order.dao"} # 这个路径根据你的情况修改
 ...
 * <p>
 * 完成上述修改后， 位于com.cp3.base.product.dao 包下的dao 将操作  master 库， com.cp3.base.order.dao中的dao 将操作slave库
 *
 * @author zuihou
