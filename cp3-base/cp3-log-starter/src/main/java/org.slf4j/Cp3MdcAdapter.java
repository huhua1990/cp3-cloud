...
public class Cp3MdcAdapter implements MDCAdapter {
    private static final int WRITE_OPERATION = 1;
    private static final int MAP_COPY_OPERATION = 2;
    private static Cp3MdcAdapter cp3MdcAdapter;

    static {
        cp3MdcAdapter = new Cp3MdcAdapter();
        MDC.mdcAdapter = cp3MdcAdapter;
    }
