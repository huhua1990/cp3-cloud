package com.cp3.base.log.aspect;
...
import com.cp3.base.context.ThreadLocalParam;
import com.cp3.base.jackson.JsonUtil;
import com.cp3.base.log.entity.OptLogDTO;
import com.cp3.base.log.event.SysLogEvent;
import com.cp3.base.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.cp3.base.basic.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.cp3.base.basic.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.cp3.base.annotation.log.SysLog) 解释：
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.cp3.base.basic.controller.*.*(..)) || @annotation(com.cp3.base.annotation.log.SysLog)")
