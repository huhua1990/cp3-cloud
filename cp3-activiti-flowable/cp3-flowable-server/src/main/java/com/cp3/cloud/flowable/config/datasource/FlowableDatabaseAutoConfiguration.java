...
@Slf4j
@MapperScan(
        basePackages = { "com.cp3.cloud", UTIL_PACKAGE }, annotationClass = Repository.class,
        sqlSessionFactoryRef = FlowableDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${cp3.database.multiTenantType}')")
public class FlowableDatabaseAutoConfiguration extends BaseMasterDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public FlowableDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 cp3.database.multiTenantType!=DATASOURCE，加载了 FlowableDatabaseAutoConfiguration");
    }
