package com.cp3.cloud.seckill.controller;

import com.cp3.cloud.auth.common.entity.UserInfo;
import com.cp3.cloud.item.pojo.SeckillGoods;
import com.cp3.cloud.common.response.Result;
import com.cp3.cloud.seckill.access.AccessLimit;
import com.cp3.cloud.item.client.GoodsClient;
import com.cp3.cloud.seckill.interceptor.LoginInterceptor;
...
public class SeckillController implements InitializingBean {
    ...
    private static final String KEY_PREFIX = "cp3:seckill:stock";
