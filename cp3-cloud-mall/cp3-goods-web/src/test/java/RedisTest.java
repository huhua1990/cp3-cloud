import com.cp3.cloud.goods.web.LyGoodsWebApplication;
...
public class RedisTest {
    ...
    private static final String KEY_PREFIX = "cp3:seckill:test";
    ...
    @Test
    public void test(){
        BoundHashOperations<String,Object,Long> hashOperations = this.stringRedisTemplate.boundHashOps("cp3:goods:detail:1");
        BoundValueOperations<String, String> valueOperations = this.stringRedisTemplate.boundValueOps("cp3:goods:detail:1");
